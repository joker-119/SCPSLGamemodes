...
namespace JuggernautGamemode
{
	...
	public class Juggernaut : Plugin
	{
		...
		{
			this.AddConfig(new ConfigSetting("juggernaut_base_health", 500, true, "The amoutn of base health the Juggernaut starts with."));
			this.AddConfig(new ConfigSetting("juggernaut_increase_amount", 500, true, "The amount of extra HP a Jugg gets for each additional player."));
			this.AddConfig(new ConfigSetting("juggernaut_jugg_grenades", 6, true, "The number of grenades the Jugg should start with."));
			this.AddConfig(new ConfigSetting("juggernaut_ntf_disarmer", false, true, "Wether or not NTF should spawn with Disarmers."));
			this.AddConfig(new ConfigSetting("juggernaut_ntf_ammo", 272, true, "The amount of ammo NTF Commanders should spawn with."));
			this.AddConfig(new ConfigSetting("juggernaut_ntf_health", 150, true, "The amount of health the first wave of NTF should have."));
			this.AddConfig(new ConfigSetting("juggernaut_critical_damage", (float)0.15, true, "The amount of critical damage the Juggernaut should recieve."));
			this.AddConfig(new ConfigSetting("juggernaut_infinite_jugg_nades", false, true, "If the Juggernaut should have infinite grenades."));
			this.AddConfig(new ConfigSetting("juggernaut_health_bar_type", "bar", false, true, "Type of Health Bar to use for Juggernaut"));
			this.AddConfig(new ConfigSetting("jugg_gamemode_ranks", new string[] { }, true, "The ranks able to use commands."));
